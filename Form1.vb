Public Class Form1
    ...
    Private Sub ItemSubtractFood_Click(sender As Object, e As EventArgs) Handles ItemSubtractFood.Click
        ...
        If ButtonGrain.Enabled = False And Not ItemQuantity(0) = 0 Then 'Credit: Hugh Triglone
    ...
    Private Sub ButtonSubmit_Click(sender As Object, e As EventArgs) Handles ButtonSubmit.Click 'Receipt Generation Button
        ...
        TotalPriceString = (Convert.ToString(TotalPrice))
        ...
        TotalPrice = ItemPrice(0) * ItemQuantity(0) + ItemPrice(1) * ItemQuantity(1) + ItemPrice(2) * ItemQuantity(2) + ItemPrice(3) * ItemQuantity(3) + ItemPrice(4) * ItemQuantity(4) + ItemPrice(5) * ItemQuantity(5) + ItemPrice(6) * ItemQuantity(6) + ItemPrice(7) * ItemQuantity(8) + ItemPrice(9) * ItemQuantity(9)
        'looooooong equation
        ...
        If ButtonDelivery.Enabled = False Then 'Displays all information necessary for delivery contact
            ...
            'Next step Add try catches for literally everything in new order and order details screen
        End If
